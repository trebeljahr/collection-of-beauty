// Ported from ricos.site 3D dungeon generator
// (/Users/rico/projects/ricos.site/src/canvas/Dungeon/Generator3D/Types.ts).
// Original algorithm by vazgriz, ported to TypeScript for web use by Rico.
