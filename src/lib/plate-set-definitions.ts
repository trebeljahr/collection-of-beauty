...
export const PLATE_SETS: PlateSetDefinition[] = [
  ...
  },
  {
    ...
    intro: [
      "Ernst Haeckel published Kunstformen der Natur in ten instalments of ten plates between 1899 and 1904, then as the collected hundred-plate volume the set is usually known by. Haeckel was a zoologist — he described thousands of new species, named the radiolarians that fill the opening plates, and coined the word ecology — but this book was not written for zoologists. It was an argument, aimed at artists and the general reader, that symmetry and pattern in nature are worth looking at as design.",
  ...
  },
  {
    ...
    tagline: "Redouté's roses — the most reproduced botanical plates ever made.",
    intro: [
      "Les Roses is the book that made Pierre-Joseph Redouté the most copied botanical artist in history. Issued in parts from 1817, it pairs his plates with descriptive text by the botanist Claude-Antoine Thory, who did the taxonomy while Redouté did the looking. Redouté had been drawing master to Marie Antoinette and then flower painter to the Empress Joséphine, and much of what he drew here he drew from Joséphine's garden at Malmaison, which held the most complete rose collection in Europe.",
  ...
  },
  {
    ...
    intro: [
      "Les Liliacées is Redouté's largest work and, by his own reckoning, his best. Eight folio volumes appeared between 1802 and 1816, funded largely by the Empress Joséphine, and the subject is far broader than the title suggests: alongside true lilies the plates cover irises, amaryllis, agapanthus, orchids, aloes, gingers and a good deal else that early-nineteenth-century botany filed under Liliaceae before the family was broken apart.",
