    ...
    <div className="mx-auto max-w-7xl px-4 py-8 md:py-12">
      ...
      <header className="mb-8 max-w-prose">
        ...
        <p className="mt-3 text-[var(--muted-foreground)]">
          Most of this collection is assembled work by work. These four are different: each is a
          single illustrated book, held as a whole run and presented in the order its plates were
          published — {totalPlates.toLocaleString()} plates between them.
        </p>
        <p className="mt-3 text-[var(--muted-foreground)]">
          Where a run is short of the full set, the page says so and lists the plate numbers that
          are missing.
        </p>
      </header>
