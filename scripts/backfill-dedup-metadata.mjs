...
const PAIRS = [
  {
    keep: "collection-of-beauty-1280px-arcimboldo-winter-1563",
    keepFn: "1280px-Arcimboldo_Winter_1563.jpg",
    drop: "collection-of-beauty-arcimboldo-winter-1563",
    dropFn: "Arcimboldo_Winter_1563.jpg",
    title: "Allegory of Winter",
  },
  {
    keep: "collection-of-beauty-giuseppe-arcimboldo-four-seasons-in-one-head-google-art-project",
    keepFn: "Giuseppe_Arcimboldo_-_Four_Seasons_in_One_Head_-_Google_Art_Project.jpg",
    drop: "collection-of-beauty-1280px-giuseppe-arcimboldo-four-seasons-in-one-head-google-art-project",
    dropFn: "1280px-Giuseppe_Arcimboldo_-_Four_Seasons_in_One_Head_-_Google_Art_Project.jpg",
  },
  {
    keep: "collection-of-beauty-el-greco-domenikos-theotokopoulos-laocoon-google-art-project",
    keepFn: "El_Greco_(Domenikos_Theotokopoulos)_-_Laocoön_-_Google_Art_Project.jpg",
    drop: "collection-of-beauty-el-greco-042",
    dropFn: "El_Greco_042.jpg",
    title: "Laocoön",
  },
  {
    keep: "collection-of-beauty-scene-des-massacres-de-scio",
    keepFn: "Scène_des_massacres_de_Scio.jpg",
    drop: "collection-of-beauty-scene-des-massacres-de-scio-eugene-delacroix-musee-du-louvre-peintures-inv-3823-c3",
    dropFn:
      "Scène_des_massacres_de_Scio,_Eugène_Delacroix_-_Musée_du_Louvre_Peintures_INV_3823_;_C3.jpg",
  },
  {
    keep: "collection-of-beauty-femmes-d-alger-dans-leur-appartement-eugene-delacroix-musee-du-louvre-peintures-inv-3824",
    keepFn:
      "Femmes_d'Alger_dans_leur_appartement,_Eugène_Delacroix_-_Musée_du_Louvre_Peintures_INV_3824.jpg",
    drop: "collection-of-beauty-eugene-delacroix-les-femmes-d-alger-dans-leur-appartement-1834",
    dropFn: "Eugène_Delacroix_-_Les_Femmes_d'Alger_dans_leur_appartement,_1834.jpg",
  },
  {
    keep: "collection-of-beauty-jean-francois-millet-the-sheepfold-moonlight-google-art-project",
    keepFn: "Jean-François_Millet_-_The_Sheepfold,_Moonlight_-_Google_Art_Project.jpg",
    drop: "collection-of-beauty-jean-francois-millet-the-sheepfold-moonlight-walters-3730",
    dropFn: "Jean-François_Millet_-_The_Sheepfold,_Moonlight_-_Walters_3730.jpg",
  },
  {
    keep: "collection-of-beauty-manet-musica-en-las-tullerias-national-gallery-londres-1862",
    keepFn: "MANET_-_Música_en_las_Tullerías_(National_Gallery,_Londres,_1862).jpg",
    drop: "collection-of-beauty-edouard-manet-music-in-the-tuileries-1862",
    dropFn: "Edouard_Manet_Music_in_the_Tuileries_1862.jpg",
  },
  {
    keep: "collection-of-beauty-ilya-repin-what-freedom",
    keepFn: "Ilya_Repin-What_freedom!.jpg",
    drop: "collection-of-beauty-69149f",
    dropFn: "Илья_Репин_-_Какой_простор.jpg",
  },
  {
    keep: "collection-of-beauty-edgar-germain-hilaire-degas-031",
    keepFn: "Edgar_Germain_Hilaire_Degas_031.jpg",
    drop: "collection-of-beauty-2560px-edgar-germain-hilaire-degas-031",
    dropFn: "2560px-Edgar_Germain_Hilaire_Degas_031.jpg",
    englishTitle: "The Tub",
  },
];
...
const histJson = (rel) =>
  JSON.parse(execSync(`git show ${HISTORY_REF}:${rel}`, { maxBuffer: 300e6 }).toString());
...
const provLive = (fn) => {
  const k = provKeyByNFC.get(nfc(fn));
  return k ? prov[k] : null;
};
const provHist = (fn) => {
  const k = hProvKeyByNFC.get(nfc(fn));
  return k ? hProv[k] : null;
};
...
for (const p of PAIRS) {
  ...
  if (p.englishTitle && !tovr[keepOK]) {
    tovr[keepOK] = p.englishTitle;
    tags.push("eng");
  }
  ...
  if (dropEntryKey || fs.existsSync(srcPath)) {
    ...
    fs.rmSync(path.join(ASSETS_WEB, "collection-of-beauty", p.dropFn.replace(/\.[^.]+$/, "")), {
      recursive: true,
      force: true,
    });
  ...
  if (tags.length) {
    backfilled++;
    console.log(`${p.keep.replace("collection-of-beauty-", "")}: ${tags.join(", ")}`);
  }
}
