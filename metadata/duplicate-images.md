...
- `collection-of-beauty-claude-monet-waterlilies-google-art-project-hgenpzjbk2sthg` — Waterlilies — `collection-of-beauty/Claude_Monet_-_Waterlilies_-_Google_Art_Project_(hgEnPzjBK2STHg).jpg`
...
- `collection-of-beauty-gustave-courbet-la-vague-google-art-project` — The Wave — `collection-of-beauty/Gustave_Courbet_-_La_vague_-_Google_Art_Project.jpg`
...
- (Δ3) `audubon-birds-394-i-chestnut-coloured-finch-2-black-headed-siskin-3-black-crown-bunting-4-arctic-ground-finch` — 394 I. Chestnut-coloured Finch - 2. Black-headed Siskin - 3. Black crown Bunting - 4. Arctic Ground Finch — John James Audubon — `audubon-birds/394_I._Chestnut-coloured_Finch_-_2._Black-headed_Siskin_-_3._Black_crown_Bunting_-_4._Arctic_Ground_Finch.jpg`

### Seed `86a2f8f0f0f084a2`
- (seed) `audubon-birds-185-bachman-s-warbler` — 185 Bachman's Warbler — John James Audubon — `audubon-birds/185_Bachman's_Warbler.jpg`
- (Δ4) `audubon-birds-29-towhe-bunting` — 29 Towhe Bunting — John James Audubon — `audubon-birds/29_Towhe_Bunting.jpg`

### Seed `80e4f0d8f0f08ca0`
- (seed) `audubon-birds-190-yellow-bellied-woodpecker` — 190 Yellow bellied Woodpecker — John James Audubon — `audubon-birds/190_Yellow_bellied_Woodpecker.jpg`
- (Δ4) `audubon-birds-45-traill-s-flycatcher` — 45 Traill's Flycatcher — John James Audubon — `audubon-birds/45_Traill's_Flycatcher.jpg`

### Seed `b0f0a0f0696896f0`
- (seed) `audubon-birds-299-dusky-petrel` — 299 Dusky Petrel — John James Audubon — `audubon-birds/299_Dusky_Petrel.jpg`
- (Δ4) `audubon-birds-330-ring-plover` — 330 Ring Plover — John James Audubon — `audubon-birds/330_Ring_Plover.jpg`

### Seed `a0ccb2f0f0f0c4a8`
- (seed) `audubon-birds-358-pine-grosbeak` — 358 Pine Grosbeak — John James Audubon — `audubon-birds/358_Pine_Grosbeak.jpg`
- (Δ3) `audubon-birds-395-i-audubon-s-warbler-2-hermit-warbler-3-black-throated-gray-warbler` — 395 I. Audubon's Warbler - 2. Hermit Warbler - 3. Black-throated gray Warbler — John James Audubon — `audubon-birds/395_I._Audubon's_Warbler_-_2._Hermit_Warbler_-_3._Black-throated_gray_Warbler.jpg`
