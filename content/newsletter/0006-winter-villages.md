...
artworks:
  ...
  - id: "collection-of-beauty-hendrik-avercamp-winter-scene-on-a-canal-google-art-project"
    note: "Avercamp's frozen canal is a town square with no roof: skaters, sledges, peat carts, gentry chatting with peasants, somebody mid-fall waiting to be helped up. There are dozens of little incidents and you can spend a genuinely long time finding them all — this is a painting that rewards nosiness. Avercamp was deaf and mute, signed his prints 'the Mute of Kampen', and spent his whole career watching his town perform itself on the ice. All that observation, none of it through conversation. Maybe that is exactly why he saw so much."
  - id: "collection-of-beauty-rembrandt-winterlandschap-1646"
    note: "Rembrandt barely painted landscapes in oil, and when he did, he did this: a small panel, brushed thin and fast, with the pale priming left showing through to play the part of frozen ground. The economy is absurd — a sledge, a few skaters, low farm buildings, and an entire cold afternoon, conjured mostly out of what he *didn't* paint. After Avercamp's hundred-character canal, Rembrandt clears the ice almost completely. Both feel true. Winter does both things."
  - id: "collection-of-beauty-caspar-david-friedrich-abtei-im-eichwald-google-art-project"
    note: "And then Friedrich takes the village away entirely. A line of monks carries a coffin into a ruined Gothic abbey, bare oaks black against the last light, snow dusted over the graves. He exhibited this beside *The Monk by the Sea* — the painting that opened [the very first issue](/newsletter/0001-solitary-figures-landscape) — and one stunned reviewer called this one an apocalypse. The king of Prussia bought the pair on the spot. It is bleak, yes, but look how *organized* it is: the procession, the ruin and the oaks all hold the picture upright like the ribs of one cold cathedral."
---
